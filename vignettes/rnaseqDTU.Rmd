...
sample **NOTE: which specific sample** of the GEUVADIS project (cite GEUVADIS, Salmon), and this was used as
a baseline for transcript abundances in the simulation.
