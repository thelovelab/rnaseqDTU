...
to run on estimated transcript counts, in order to detect DTU. The
usage of *DEXSeq* on transcript counts was evaluated by
...
We used *tximport* to summarize counts to the
