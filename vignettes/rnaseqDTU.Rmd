...
```{r plotProp, out.width="50%", fig.cap="Estimated proportions for one of the significant genes."}
...
Show code for doing DGE, tximport followed by DESeq2 and edgeR

Make a plot of gene-level transcript usage over total expression log10 p-values
