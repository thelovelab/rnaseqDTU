...
variability of expression level across samples, and realistic coverage
...
sample of the GEUVADIS project (cite GEUVADIS, Salmon), and this was used a
baseline for transcript abundances in the simulation.
*alpine* was used to estimate realistic fragment GC bias from 12 samples from the GEUVADIS
project from the same center (cite alpine). *DESeq2* was
...
TODO: consider removing this, and substituting with a non-specific
variance filter on proportions
